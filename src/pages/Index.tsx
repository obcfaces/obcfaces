    ...
    <div className="min-h-screen bg-background">
      ...
      {activeSection === "Contest" && (
        <>
          ...
          {/* TEMPORARY: Show message instead of ContestSection */}
          <div className="max-w-6xl mx-auto p-8 text-center">
            <h2 className="text-xl font-bold mb-4">Contest Sections Temporarily Disabled</h2>
            <p>We're gradually restoring functionality to avoid recursion issues.</p>
          </div>
