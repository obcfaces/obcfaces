            ...
            <TabsContent value="weekly" className="space-y-4">
              ...
              {(() => {
                ...
                return filteredWeeklyParticipants.map((participant) => {
                  ...
                  return (
                     <Card key={participant.id} className="overflow-hidden relative h-37">
                   ...
                   return uniqueApplications.map((application) => {
                    ...
                    return (
                      <div key={application.id}>
                         <Card className="overflow-hidden relative rounded-none border-l-0 border-r-0 md:rounded-lg md:border-l md:border-r h-37">
                           ...
                           <div className="mt-2 space-y-2">
                             {(showDeletedApplications ? deletedApplications : contestApplications)
                               ...
                               .map((prevApp) => {
                                 ...
                                 return (
                                   <Card key={prevApp.id} className="overflow-hidden relative mx-0 rounded-lg bg-muted/30 h-37">
                                     {/* Edit button in bottom left corner */}
                                     {!showDeletedApplications && (
                                       <Button
                                         size="sm"
