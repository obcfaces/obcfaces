...
const PHILIPPINES_CITIES = {
  ...
  // Western Visayas cities - comprehensive list
  'WES': ['Iloilo City', 'Bacolod', 'Roxas City', 'Kalibo', 'San Jose', 'Jordan', 'Passi', 'Ajuy', 'Alimodian', 'Anilao', 'Badiangan', 'Balasan', 'Banate', 'Barotac Nuevo', 'Barotac Viejo', 'Batad', 'Bingawan', 'Bocari', 'Bugasong', 'Cabatuan', 'Calinog', 'Carles', 'Concepcion', 'Dingle', 'Duenas', 'Dumangas', 'Estancia', 'Guimbal', 'Igbaras', 'Janiuay', 'Lambunao', 'Leganes', 'Lemery', 'Leon', 'Maasin', 'Miagao', 'Mina', 'New Lucena', 'Oton', 'Pavia', 'Pototan', 'San Dionisio', 'San Enrique', 'San Joaquin', 'San Miguel', 'San Rafael', 'Santa Barbara', 'Sara', 'Tigbauan', 'Tubungan', 'Zarraga', 'Talisay', 'Silay', 'Cadiz', 'Sagay', 'Escalante', 'Manapla', 'Victorias', 'Toboso', 'Calatrava', 'Pulupandan', 'Valladolid', 'Pontevedra', 'Hinigaran', 'La Carlota', 'Bago', 'Murcia', 'Don Salvador Benedicto', 'La Castellana', 'Moises Padilla', 'Isabela', 'Binalbagan', 'Himamaylan', 'Kabankalan', 'Ilog', 'Cauayan', 'Candoni', 'Hinoba-an', 'Panay', 'Panitan', 'President Roxas', 'Pilar', 'Sigma', 'Sapian', 'Jamindan', 'Tapaz', 'Dumalag', 'Dumarao', 'Dao', 'Cuartero', 'Mambusao', 'Ivisan', 'Ibajay', 'Nabas', 'Malay', 'Buruanga', 'Makato', 'Numancia', 'Lezo', 'Madalag', 'Libacao', 'New Washington', 'Batan', 'Altavas', 'Banga', 'Sibalom', 'Hamtic', 'Tobias Fornier', 'Anini-y', 'Patnongon', 'Bugasong', 'Valderrama', 'Barbaza', 'Laua-an', 'Culasi', 'Sebaste', 'Pandan', 'Libertad', 'Caluya', 'San Remigio', 'Belison', 'Tibiao', 'Buenavista', 'Nueva Valencia', 'San Lorenzo', 'Sibunag'],
  'WESTERN_VISAYAS': ['Iloilo City', 'Bacolod', 'Roxas City', 'Kalibo', 'San Jose', 'Jordan', 'Passi', 'Ajuy', 'Alimodian', 'Anilao', 'Badiangan', 'Balasan', 'Banate', 'Barotac Nuevo', 'Barotac Viejo', 'Batad', 'Bingawan', 'Bocari', 'Bugasong', 'Cabatuan', 'Calinog', 'Carles', 'Concepcion', 'Dingle', 'Duenas', 'Dumangas', 'Estancia', 'Guimbal', 'Igbaras', 'Janiuay', 'Lambunao', 'Leganes', 'Lemery', 'Leon', 'Maasin', 'Miagao', 'Mina', 'New Lucena', 'Oton', 'Pavia', 'Pototan', 'San Dionisio', 'San Enrique', 'San Joaquin', 'San Miguel', 'San Rafael', 'Santa Barbara', 'Sara', 'Tigbauan', 'Tubungan', 'Zarraga', 'Talisay', 'Silay', 'Cadiz', 'Sagay', 'Escalante', 'Manapla', 'Victorias', 'Toboso', 'Calatrava', 'Pulupandan', 'Valladolid', 'Pontevedra', 'Hinigaran', 'La Carlota', 'Bago', 'Murcia', 'Don Salvador Benedicto', 'La Castellana', 'Moises Padilla', 'Isabela', 'Binalbagan', 'Himamaylan', 'Kabankalan', 'Ilog', 'Cauayan', 'Candoni', 'Hinoba-an', 'Panay', 'Panitan', 'President Roxas', 'Pilar', 'Sigma', 'Sapian', 'Jamindan', 'Tapaz', 'Dumalag', 'Dumarao', 'Dao', 'Cuartero', 'Mambusao', 'Ivisan', 'Ibajay', 'Nabas', 'Malay', 'Buruanga', 'Makato', 'Numancia', 'Lezo', 'Madalag', 'Libacao', 'New Washington', 'Batan', 'Altavas', 'Banga', 'Sibalom', 'Hamtic', 'Tobias Fornier', 'Anini-y', 'Patnongon', 'Bugasong', 'Valderrama', 'Barbaza', 'Laua-an', 'Culasi', 'Sebaste', 'Pandan', 'Libertad', 'Caluya', 'San Remigio', 'Belison', 'Tibiao', 'Buenavista', 'Nueva Valencia', 'San Lorenzo', 'Sibunag'],
  ...
  '01': ['Laoag', 'Vigan', 'San Fernando', 'Batac', 'Candon', 'Alaminos', 'Dagupan', 'San Carlos', 'Urdaneta', 'Agoo', 'Aringay', 'Bacnotan', 'Bagulin', 'Balaoan', 'Bangar', 'Bauang', 'Burgos', 'Caba', 'Luna', 'Naguilian', 'Pugo', 'Rosario', 'San Gabriel', 'San Juan', 'Santo Tomas', 'Santol', 'Sudipen', 'Tubao'],
  '02': ['Tuguegarao', 'Ilagan', 'Cauayan', 'Santiago', 'Aparri', 'Alcala', 'Allacapan', 'Amulung', 'Abulug', 'Baggao', 'Ballesteros', 'Buguey', 'Calayan', 'Camalaniugan', 'Claveria', 'Enrile', 'Gattaran', 'Gonzaga', 'Iguig', 'Lal-lo', 'Lasam', 'Pamplona', 'Peñablanca', 'Piat', 'Rizal', 'Sanchez-Mira', 'Santa Ana', 'Santa Praxedes', 'Santa Teresita', 'Santo Niño', 'Solana', 'Tuao'],
  '03': ['San Fernando', 'Angeles', 'Mabalacat', 'Cabanatuan', 'Gapan', 'San Jose', 'Palayan', 'Muñoz', 'Malolos', 'Meycauayan', 'San Jose del Monte', 'Marilao', 'Bocaue', 'Tarlac City', 'Concepcion', 'Capas', 'Bamban', 'Olongapo', 'Subic', 'Castillejos', 'Balanga', 'Mariveles', 'Bagac', 'Hermosa', 'Limay', 'Morong', 'Orani', 'Orion', 'Pilar', 'Samal', 'Abucay', 'Dinalupihan', 'Baler', 'Casiguran', 'Dilasag', 'Dinalungan', 'Dingalan', 'Dipaculao', 'Maria Aurora', 'San Luis'],
  '4A': ['Santa Rosa', 'Biñan', 'San Pedro', 'Cabuyao', 'Calamba', 'Los Baños', 'Antipolo', 'Cainta', 'Taytay', 'Angono', 'Binangonan', 'Bacoor', 'Imus', 'Dasmariñas', 'General Trias', 'Trece Martires', 'Batangas City', 'Lipa', 'Tanauan', 'Santo Tomas', 'Lucena', 'Tayabas', 'Sariaya', 'Candelaria'],
  '4B': ['Puerto Princesa', 'Aborlan', 'Agutaya', 'Araceli', 'Balabac', 'Bataraza', 'Brooke\'s Point', 'Busuanga', 'Cagayancillo', 'Coron', 'Culion', 'Cuyo', 'Dumaran', 'El Nido', 'Linapacan', 'Magsaysay', 'Narra', 'Quezon', 'Rizal', 'Roxas', 'San Vicente', 'Sofronio Española', 'Taytay', 'Kalayaan', 'Boac', 'Buenavista', 'Gasan', 'Mogpog', 'Santa Cruz', 'Torrijos', 'Mamburao', 'Abra de Ilog', 'Calintaan', 'Looc', 'Lubang', 'Magsaysay', 'Paluan', 'Rizal', 'Sablayan', 'San Jose', 'Santa Cruz', 'Calapan', 'Baco', 'Bansud', 'Bongabong', 'Bulalacao', 'Gloria', 'Mansalay', 'Naujan', 'Pinamalayan', 'Pola', 'Puerto Galera', 'Roxas', 'San Teodoro', 'Socorro', 'Victoria', 'Romblon', 'Alcantara', 'Banton', 'Cajidiocan', 'Calatrava', 'Concepcion', 'Corcuera', 'Ferrol', 'Looc', 'Magdiwang', 'Odiongan', 'San Agustin', 'San Andres', 'San Fernando', 'San Jose', 'Santa Fe', 'Santa Maria'],
  '05': ['Legazpi', 'Ligao', 'Tabaco', 'Naga', 'Iriga', 'Pili', 'Daet', 'Jose Panganiban', 'Labo', 'Virac', 'Bato', 'Bagamanoc', 'Masbate City', 'Aroroy', 'Baleno', 'Sorsogon City', 'Bacon', 'Barcelona'],
  '06': ['Iloilo City', 'Bacolod', 'Roxas City', 'Kalibo', 'San Jose', 'Jordan', 'Passi', 'Ajuy', 'Alimodian', 'Anilao', 'Badiangan', 'Balasan', 'Banate', 'Barotac Nuevo', 'Barotac Viejo', 'Batad', 'Bingawan', 'Bocari', 'Bugasong', 'Cabatuan', 'Calinog', 'Carles', 'Concepcion', 'Dingle', 'Duenas', 'Dumangas', 'Estancia', 'Guimbal', 'Igbaras', 'Janiuay', 'Lambunao', 'Leganes', 'Lemery', 'Leon', 'Maasin', 'Miagao', 'Mina', 'New Lucena', 'Oton', 'Pavia', 'Pototan', 'San Dionisio', 'San Enrique', 'San Joaquin', 'San Miguel', 'San Rafael', 'Santa Barbara', 'Sara', 'Tigbauan', 'Tubungan', 'Zarraga', 'Talisay', 'Silay', 'Cadiz', 'Sagay', 'Escalante', 'Manapla', 'Victorias', 'Toboso', 'Calatrava', 'Pulupandan', 'Valladolid', 'Pontevedra', 'Hinigaran', 'La Carlota', 'Bago', 'Murcia', 'Don Salvador Benedicto', 'La Castellana', 'Moises Padilla', 'Isabela', 'Binalbagan', 'Himamaylan', 'Kabankalan', 'Ilog', 'Cauayan', 'Candoni', 'Hinoba-an', 'Panay', 'Panitan', 'President Roxas', 'Pilar', 'Sigma', 'Sapian', 'Jamindan', 'Tapaz', 'Dumalag', 'Dumarao', 'Dao', 'Cuartero', 'Mambusao', 'Ivisan', 'Ibajay', 'Nabas', 'Malay', 'Buruanga', 'Makato', 'Numancia', 'Lezo', 'Madalag', 'Libacao', 'New Washington', 'Batan', 'Altavas', 'Banga', 'Sibalom', 'Hamtic', 'Tobias Fornier', 'Anini-y', 'Patnongon', 'Valderrama', 'Barbaza', 'Laua-an', 'Culasi', 'Sebaste', 'Pandan', 'Libertad', 'Caluya', 'San Remigio', 'Belison', 'Tibiao', 'Buenavista', 'Nueva Valencia', 'San Lorenzo', 'Sibunag'],
  '07': ['Cebu City', 'Mandaue City', 'Lapu-Lapu City', 'Talisay City', 'Toledo City', 'Danao City', 'Carcar City', 'Naga City', 'Bogo City', 'Minglanilla', 'Consolacion', 'Liloan', 'Compostela', 'Cordova', 'Bantayan', 'Madridejos', 'Santa Fe', 'Daanbantayan', 'Medellin', 'Badian', 'Moalboal', 'Alcantara', 'Ronda', 'Dumanjug', 'Barili', 'Aloguinsan', 'Pinamungajan', 'Tabogon', 'Sogod', 'Catmon', 'Carmen', 'San Fernando', 'Sibonga', 'Argao', 'Dalaguete', 'Alcoy', 'Boljoon', 'Oslob', 'Santander', 'Samboan', 'Ginatilan', 'Malabuyoc', 'Alegria', 'Tuburan', 'Asturias', 'Balamban', 'Tagbilaran', 'Tubigon', 'Calape', 'Loon', 'Maribojoc', 'Antequera', 'Baclayon', 'Alburquerque', 'Loboc', 'Sikatuna', 'Carmen', 'Garcia Hernandez', 'Valencia', 'Dimiao', 'Lila', 'Loay', 'Panglao', 'Dauis', 'Cortes', 'Corella', 'Balilihan', 'Catigbian', 'Batuan', 'Sevilla', 'Bilar', 'Sagbayan', 'Sierra Bullones', 'Pilar', 'Dagohoy', 'Danao', 'Trinidad', 'Talibon', 'Bien Unido', 'Ubay', 'San Miguel', 'San Isidro', 'Alicia', 'Mabini', 'Candijay', 'Anda', 'Guindulman', 'Duero', 'Jagna', 'Clarin', 'Inabanga', 'Buenavista', 'Getafe', 'President Carlos P. Garcia', 'Dumaguete', 'Bais', 'Bayawan', 'Canlaon', 'Guihulngan', 'Tanjay', 'Amlan', 'Ayungon', 'Bacong', 'Basay', 'Bindoy', 'Dauin', 'Jimalalud', 'La Libertad', 'Mabinay', 'Manjuyod', 'Pamplona', 'San Jose', 'Santa Catalina', 'Siaton', 'Sibulan', 'Tayasan', 'Valencia', 'Vallehermoso', 'Zamboanguita'],
  '08': ['Tacloban', 'Ormoc', 'Baybay', 'Maasin', 'Abuyog', 'Alangalang', 'Albuera', 'Babatngon', 'Barugo', 'Bato', 'Calubian', 'Capoocan', 'Carigara', 'Dagami', 'Dulag', 'Hilongos', 'Hindang', 'Inopacan', 'Isabel', 'Jaro', 'Javier', 'Julita', 'Kananga', 'La Paz', 'Leyte', 'MacArthur', 'Mahaplag', 'Matag-ob', 'Matalom', 'Mayorga', 'Merida', 'Palo', 'Palompon', 'Pastrana', 'San Isidro', 'San Miguel', 'Santa Fe', 'Tabango', 'Tabontabon', 'Tanauan', 'Tolosa', 'Tunga', 'Villaba', 'Catbalogan', 'Calbayog', 'Basey', 'Calbiga', 'Daram', 'Gandara', 'Hinabangan', 'Jiabong', 'Marabut', 'Matuguinao', 'Motiong', 'Pinabacdao', 'San Jorge', 'San Jose de Buan', 'San Sebastian', 'Santa Margarita', 'Santa Rita', 'Santo Niño', 'Tagapul-an', 'Talalora', 'Tarangnan', 'Villareal', 'Zumarraga', 'Almagro', 'Pagsanghan', 'Borongan', 'Arteche', 'Balangiga', 'Balangkayan', 'Can-avid', 'Dolores', 'General MacArthur', 'Giporlos', 'Guiuan', 'Hernani', 'Jipapad', 'Lawaan', 'Llorente', 'Maslog', 'Maydolong', 'Mercedes', 'Oras', 'Quinapondan', 'Salcedo', 'San Julian', 'San Policarpo', 'Sulat', 'Taft', 'Catarman', 'Allen', 'Biri', 'Bobon', 'Capul', 'Catubig', 'Gamay', 'Laoang', 'Lapinig', 'Las Navas', 'Lavezares', 'Mapanas', 'Mondragon', 'Palapag', 'Pambujan', 'Rosario', 'San Antonio', 'San Isidro', 'San Jose', 'San Roque', 'San Vicente', 'Silvino Lobos', 'Victoria', 'Naval', 'Almeria', 'Biliran', 'Cabucgayan', 'Caibiran', 'Culaba', 'Kawayan', 'Maripipi'],
  '09': ['Dipolog', 'Dapitan', 'Pagadian', 'Zamboanga City', 'Ipil', 'Roxas', 'Sindangan', 'Aurora', 'Bayog', 'Alicia', 'Buug', 'Sergio Osmeña Sr.', 'Katipunan', 'Manukan', 'Jose Dalman', 'Tampilisan', 'Godod', 'Bacungan', 'Baliguian', 'Gutalac', 'Kalawit', 'La Libertad', 'Labason', 'Leon B. Postigo', 'Liloy', 'Mutia', 'Piñan', 'Polanco', 'Pres. Manuel A. Roxas', 'Rizal', 'Salug', 'Siayan', 'Sibuco', 'Sibutad', 'Siocon', 'Dimataling', 'Dinas', 'Dumalinao', 'Dumingag', 'Guipos', 'Josefina', 'Kumalarang', 'Labangan', 'Lakewood', 'Lapuyan', 'Mahayag', 'Margosatubig', 'Midsalip', 'Molave', 'Pitogo', 'Ramon Magsaysay', 'San Miguel', 'San Pablo', 'Sominot', 'Tabina', 'Tambulig', 'Tigbao', 'Tukuran', 'Vincenzo A. Sagun', 'Diplahan', 'Imelda', 'Kabasalan', 'Mabuhay', 'Malangas', 'Naga', 'Olutanga', 'Payao', 'Roseller Lim', 'Siay', 'Talusan', 'Titay', 'Tungawan'],
  '10': ['Cagayan de Oro', 'Butuan', 'Iligan', 'Malaybalay', 'Valencia', 'Gingoog', 'Ozamiz', 'Tangub', 'Oroquieta', 'Balingasag', 'Balingoan', 'Binuangan', 'Claveria', 'El Salvador', 'Gitagum', 'Initao', 'Jasaan', 'Kinoguitan', 'Lagonglong', 'Laguindingan', 'Libertad', 'Lugait', 'Magsaysay', 'Manticao', 'Naawan', 'Opol', 'Salay', 'Sugbongcogon', 'Tagoloan', 'Talisayan', 'Villanueva', 'Aloran', 'Baliangao', 'Bonifacio', 'Calamba', 'Clarin', 'Concepcion', 'Don Victoriano Chiongbian', 'Jimenez', 'Lopez Jaena', 'Panaon', 'Plaridel', 'Sapang Dalaga', 'Sinacaban', 'Tudela', 'Buenavista', 'Carmen', 'Jabonga', 'Kitcharao', 'Las Nieves', 'Magallanes', 'Nasipit', 'Remedios T. Romualdez', 'Santiago', 'Tubay', 'Cabadbaran', 'Bayugan', 'Bunawan', 'Esperanza', 'La Paz', 'Loreto', 'Prosperidad', 'Rosario', 'San Francisco', 'San Luis', 'Santa Josefa', 'Sibagat', 'Talacogon', 'Trento', 'Veruela', 'Barobo', 'Bayabas', 'Cagwait', 'Cantilan', 'Carmen', 'Carrascal', 'Cortes', 'Hinatuan', 'Lanuza', 'Lianga', 'Lingig', 'Madrid', 'Marihatag', 'San Agustin', 'San Miguel', 'Tagbina', 'Tago', 'Tandag', 'Bislig', 'Surigao City', 'Alegria', 'Bacuag', 'Burgos', 'Claver', 'Dapa', 'Del Carmen', 'General Luna', 'Gigaquit', 'Mainit', 'Malimono', 'Pilar', 'Placer', 'San Benito', 'San Francisco', 'San Isidro', 'Santa Monica', 'Sison', 'Socorro', 'Tubod'],
  '11': ['Davao City', 'Digos', 'Tagum', 'Panabo', 'Samal', 'Mati', 'Bansalan', 'Hagonoy', 'Kiblawan', 'Magsaysay', 'Malalag', 'Matanao', 'Padada', 'Santa Cruz', 'Sulop', 'Asuncion', 'Braulio E. Dujali', 'Carmen', 'Kapalong', 'New Corella', 'San Isidro', 'Santo Tomas', 'Talaingod', 'Baganga', 'Banaybanay', 'Boston', 'Caraga', 'Cateel', 'Governor Generoso', 'Lupon', 'Manay', 'San Isidro', 'Tarragona', 'Nabunturan', 'Pantukan', 'Compostela', 'Laak', 'Mabini', 'Maco', 'Maragusan', 'Mawab', 'Monkayo', 'Montevista', 'New Bataan', 'Malita', 'Don Marcelino', 'Jose Abad Santos', 'Santa Maria', 'Sarangani'],
  '12': ['Koronadal', 'General Santos', 'Kidapawan', 'Cotabato', 'Banga', 'Lake Sebu', 'Norala', 'Polomolok', 'Santo Niño', 'Surallah', 'T\'Boli', 'Tampakan', 'Tantangan', 'Tupi', 'Alabel', 'Glan', 'Kiamba', 'Maasim', 'Maitum', 'Malapatan', 'Malungon', 'Alamada', 'Aleosan', 'Antipas', 'Arakan', 'Banisilan', 'Carmen', 'Kabacan', 'Libungan', 'M\'lang', 'Magpet', 'Makilala', 'Matalam', 'Midsayap', 'Pigcawayan', 'Pikit', 'President Roxas', 'Tulunan', 'Isulan', 'Bagumbayan', 'Columbio', 'Esperanza', 'Kalamansig', 'Lebak', 'Lutayan', 'Lambayong', 'Palimbang', 'President Quirino', 'Sen. Ninoy Aquino', 'Tacurong'],
  ...
  // Abra
  'ABR': ['Bangued', 'Boliney', 'Bucay', 'Bucloc', 'Daguioman', 'Danglas', 'Dolores', 'La Paz', 'Lacub', 'Lagangilang', 'Lagayan', 'Langiden', 'Licuan-Baay (Licuan)', 'Luba', 'Malibcong', 'Manabo', 'Peñarrubia', 'Pidigan', 'Pilar', 'Sallapadan', 'San Isidro', 'San Juan', 'San Quintin', 'Tayum', 'Tineg', 'Tubo', 'Villaviciosa'],
  
  // Agusan del Norte
  'AGN': ['Buenavista', 'Butuan City', 'Cabadbaran City', 'Carmen', 'Jabonga', 'Kitcharao', 'Las Nieves', 'Magallanes', 'Nasipit', 'Remedios T. Romualdez', 'Santiago', 'Tubay'],
