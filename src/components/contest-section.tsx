...
export function ContestSection({ title, subtitle, description, isActive, showWinner, centerSubtitle, titleSuffix, noWrapTitle, viewMode: controlledViewMode, filters, weekOffset = 0 }: ContestSectionProps) {
  ...
  return (
    <section className={`max-w-6xl mx-auto mb-2 rounded-lg shadow-lg shadow-foreground/15 ${title === "THIS WEEK" ? "bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800" : "bg-background"} pt-4 pb-0`}>
      <div className="mb-4 px-6">
        <div className="mb-4">
          <div className="flex items-baseline gap-3 mb-1">
            ...
            <p className={`text-sm ${title === "THIS WEEK" ? "text-green-600 dark:text-green-400" : "text-muted-foreground/70"} italic self-center`}>{subtitle}</p>
            {titleSuffix && (
