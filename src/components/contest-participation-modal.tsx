...
export const ContestParticipationModal = ({ children }: ContestParticipationModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className="w-full max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-3">
            ...
            <div className="space-y-4 mt-4">
              <div className="flex flex-row gap-4 items-start">
                ...
                <div className="flex flex-row gap-2 items-start justify-start max-w-full overflow-visible ml-3">
                  {/* Portrait Photo */}
                  <div className="flex flex-col items-center gap-1">
                    <p className="text-xs text-muted-foreground">portrait</p>
                    <div className="relative w-10 xs:w-12 sm:w-16 md:w-24 lg:w-32 xl:w-40">
                      <input
                        type="file"
                        accept="image/*"
                        ...
                        {photo1File ? (
                          <div className="p-2 relative">
                            <img
                              ...
                              className="w-full h-16 xs:h-20 sm:h-24 md:h-32 lg:h-40 xl:h-48 object-contain rounded bg-white"
                            />
                            <button 
                              type="button"
                              onClick={(e) => {
                          ...
                          <div className="p-2 text-center">
                            <div className={`h-16 xs:h-20 sm:h-24 md:h-32 lg:h-40 xl:h-48 rounded-lg mb-2 flex items-center justify-center relative overflow-hidden aspect-[4/5] border-2 border-dashed cursor-pointer hover:border-primary transition-colors ${hasRedBorder('photo1') ? 'border-red-500' : 'border-muted-foreground/25'}`}>
                              <img 
                    ...
                    <div className="relative w-10 xs:w-12 sm:w-16 md:w-24 lg:w-32 xl:w-40">
                      ...
                      <label htmlFor="photo2-upload" className="cursor-pointer block">
                        {photo2File ? (
                          ...
                          <div className="p-2 text-center">
                            <div className={`h-16 xs:h-20 sm:h-24 md:h-32 lg:h-40 xl:h-48 rounded-lg mb-2 flex items-center justify-center relative overflow-hidden aspect-[4/5] border-2 border-dashed cursor-pointer hover:border-primary transition-colors ${hasRedBorder('photo2') ? 'border-red-500' : 'border-muted-foreground/25'}`}>
                              <img 
