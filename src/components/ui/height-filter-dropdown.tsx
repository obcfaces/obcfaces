              ...
              >
                ...
                {cmTicks.map((cm) => {
                  ...
                  return (
                    <div
                      key={`cm-${cm}`}
                      className="absolute right-[calc(50%+8px)] pr-2 -translate-y-1/2 cursor-pointer select-none text-[16px] font-semibold whitespace-nowrap hover:text-primary"
                      style={{ top: y }}
                ...
                {inchTicks.map((inch) => {
                  ...
                  return (
                    <div
                      key={`in-${inch}`}
                      className="absolute left-[calc(50%+8px)] pl-2 -translate-y-1/2 cursor-pointer select-none text-[16px] font-semibold whitespace-nowrap hover:text-primary"
                      style={{ top: y }}
                      onClick={() => onSelect?.({ system: "imperial", label: ftIn })}
                      title={ftIn}
                    >
                      {ftIn}
                    </div>
