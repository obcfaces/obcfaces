  ...
  return (
    <div className="flex justify-center gap-20 font-sans mx-auto my-10">
      <div className="flex flex-col items-center border-l-2 border-border pl-4 text-right">
         <div className="text-lg my-15">130 cm</div>
         <div className="text-lg my-15">140 cm</div>
         <div className="text-lg my-15">150 cm</div>
         <div className="text-lg my-15">160 cm</div>
         <div className="text-lg my-15">170 cm</div>
         <div className="text-lg my-15">180 cm</div>
         <div className="text-lg my-15">190 cm</div>
         <div className="text-lg my-15">200 cm</div>
      </div>
