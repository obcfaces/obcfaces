-- Revert: All status transitions should receive current week interval
...
BEGIN
  ...
  -- 3. TRANSITION: "this week" → "past" with CURRENT week interval
  ...
  -- 5. TRANSITION: "pre next week" → "next week on site" with CURRENT week interval
  UPDATE weekly_contest_participants
  SET 
