-- Move participants from 'past week 1' back to 'this week' 
-- These were participants who should have been active this week
UPDATE weekly_contest_participants 
SET admin_status = 'this week'
WHERE admin_status = 'past week 1' 
  AND is_active = true;

-- Fix the function to handle next week logic correctly
-- Remove the Monday restriction for next week participants
