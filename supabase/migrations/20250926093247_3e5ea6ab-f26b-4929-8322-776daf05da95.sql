-- Update the get_weekly_contest_participants_public function to exclude participants with admin_status = 'pending'
...
AS $function$
  ...
  WHERE wcp.is_active = true
    -- Exclude participants with admin_status = 'pending'
    AND COALESCE(wcp.admin_status, 'this week') != 'pending'
