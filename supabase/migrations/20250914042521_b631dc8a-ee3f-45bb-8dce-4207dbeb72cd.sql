...
-- Remove ALL existing permissive RLS policies and create secure ones

-- Drop all existing SELECT policies for profiles table
...
-- Update existing profiles with NULL privacy_level to 'private' (except approved contest participants)
UPDATE public.profiles 
SET privacy_level = 'private' 
WHERE privacy_level IS NULL 
AND NOT (is_contest_participant = true AND is_approved = true);