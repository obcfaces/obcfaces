-- Add admin_status column to weekly_contest_participants table
ALTER TABLE public.weekly_contest_participants 
ADD COLUMN admin_status text DEFAULT 'this week';

-- Add index for better performance on admin_status queries
CREATE INDEX idx_weekly_contest_participants_admin_status ON public.weekly_contest_participants(admin_status);
