-- Fix admin function to show all participants regardless of application status
-- since they are already in weekly_contest_participants table
...
AS $function$
  ...
  -- Show all participants that are in weekly_contest_participants table
  -- regardless of their application status since they were already added
