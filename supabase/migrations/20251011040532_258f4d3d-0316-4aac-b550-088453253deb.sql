-- Fix: Green number should show apps that were moved to pre/next/this week statuses on that day
...
BEGIN
  ...
  reserved_changes AS (
    -- Count applications that got RESERVED (pre/next/this week statuses) on each day
    SELECT 
