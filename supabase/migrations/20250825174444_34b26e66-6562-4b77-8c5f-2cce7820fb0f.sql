-- Add active column to weekly_contest_participants table
ALTER TABLE public.weekly_contest_participants 
ADD COLUMN IF NOT EXISTS is_active BOOLEAN NOT NULL DEFAULT true;

-- Add active column to contest_applications table  
ALTER TABLE public.contest_applications
ADD COLUMN IF NOT EXISTS is_active BOOLEAN NOT NULL DEFAULT true;

-- Update the get_weekly_contest_participants_public function to filter active participants
...
AS $function$
  ...
  -- Only include active participants and those with approved applications
