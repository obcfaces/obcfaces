...
-- =====================================================
-- FIX: transition_weekly_contest должна быть VOLATILE
-- =====================================================
CREATE OR REPLACE FUNCTION public.transition_weekly_contest(
...
BEGIN
  ...
  -- 4. TRANSITION: "next week on site" → "this week"
  UPDATE weekly_contest_participants
  SET 
