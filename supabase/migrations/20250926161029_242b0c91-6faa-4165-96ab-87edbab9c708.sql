-- Update the public function to only show participants with 'this week' admin_status
...
AS $function$
  ...
  WHERE wcp.is_active = true
    -- НОВАЯ ЛОГИКА: показывать только участников со статусом 'this week'
    AND COALESCE(wcp.admin_status, 'approve') = 'this week'
