-- Fix photo priority in get_weekly_contest_participants_admin function
-- Priority should be: profiles.photo_1_url FIRST, then application_data.photo1_url as fallback
...
AS $function$
  ...
  SELECT 
    ...
    p.display_name,
    -- FIXED: Prioritize profiles.photo_1_url over application_data.photo1_url
