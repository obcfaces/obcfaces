...
-- Create cron job to run every Monday at 00:01 Philippine Time (UTC+8)
-- In UTC, Philippine midnight is 16:01 the day before (Sunday)
SELECT cron.schedule(
  'weekly-status-transition-auto',
  '1 16 * * 0', -- Every Sunday at 16:01 UTC (Monday 00:01 Philippine Time)
  $$
  SELECT
    net.http_post(
