-- Now clean up duplicate ratings and fix missing links
-- First, keep only the latest rating for each user-contestant combination
...
-- Update the remaining ratings with proper user_id and participant_id links
