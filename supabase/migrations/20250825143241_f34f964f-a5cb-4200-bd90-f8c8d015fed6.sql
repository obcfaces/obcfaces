-- Fix age calculation in both functions to show actual age, not birth year

-- Fix the public function
...
AS $function$
  ...
  -- Only include participants whose latest application is approved
  WHERE EXISTS (
...
AS $function$
  ...
  -- Only show participants with approved applications
