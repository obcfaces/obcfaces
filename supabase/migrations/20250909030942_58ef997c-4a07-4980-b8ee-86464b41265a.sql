-- Change function to SECURITY DEFINER so it runs with elevated privileges
-- This allows the function to access contest_applications table on behalf of users
