-- Fix the offset calculation to properly map negative offsets to past contests
  ...
  WITH target_contest AS (
    ...
    WHERE wc.week_start_date = (
      ...
      OFFSET CASE 
        ...
        WHEN weeks_offset = -1 THEN 2  -- Skip one contest to get different participants  
        WHEN weeks_offset = -2 THEN 3  -- Skip two contests
